...
def build_summarization_prompt(title: str, text: str) -> str:
    """Build the model input from article title and source text."""
    return f"Title: {title}\n\nContent:\n{text}"


class OpenAISummarizer(Summarizer):
    """OpenAI-backed summarizer that returns structured summary + bullets."""
    ...
    def summarize(self, title: str, text: str) -> dict:
        """Generate a JSON summary payload and validate its schema."""
